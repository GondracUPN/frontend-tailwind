...
export default function ModalGastoDebito({ onClose, onSaved, userId }) { // 👈 recibe userId
  ...
  const showMoneda = ['comida','gusto','ingreso','pago_tarjeta'].includes(concepto);
